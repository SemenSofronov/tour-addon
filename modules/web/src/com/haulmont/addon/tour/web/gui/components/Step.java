...
import com.haulmont.addon.tour.web.gui.components.enums.ContentMode;
import com.haulmont.addon.tour.web.gui.components.enums.StepAnchor;
import com.haulmont.addon.tour.web.gui.components.events.step_events.*;
    ...
    public void addCancelListener(Consumer<CancelEvent> listener) {
        if (stepCancelListeners == null) {
            ...
            this.stepCancelListener = (com.haulmont.addon.tour.web.toolkit.ui.addons.producttour.step.StepCancelListener) event -> {
                CancelEvent e = new CancelEvent(Step.this);
    ...
    public void addCompleteListener(Consumer<CompleteEvent> listener) {
        if (stepCompleteListeners == null) {
            ...
            this.stepCompleteListener = (com.haulmont.addon.tour.web.toolkit.ui.addons.producttour.step.StepCompleteListener) event -> {
                CompleteEvent e = new CompleteEvent(Step.this);
    ...
    public void addHideListener(Consumer<HideEvent> listener) {
        if (stepHideListeners == null) {
            ...
            this.stepHideListener = (com.haulmont.addon.tour.web.toolkit.ui.addons.producttour.step.StepHideListener) event -> {
                HideEvent e = new HideEvent(Step.this);
    ...
    public void addShowListener(Consumer<ShowEvent> listener) {
        if (stepShowListeners == null) {
            ...
            this.stepShowListener = (com.haulmont.addon.tour.web.toolkit.ui.addons.producttour.step.StepShowListener) event -> {
                ShowEvent e = new ShowEvent(Step.this);
